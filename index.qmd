...
#| fig-cap: "Speakers' vowel means in Nearey Normalized F1,F2 space."
#| fig-width: 6.5
#| fig-height: 5
vowels_nearey %>%
  group_by(name, ipa_vclass) %>%
...
#| fig-cap: "Speakers' vowel means in Nearey Normalized F1,F2 space (fixed coordinates)."
#| fig-width: 6.5
#| fig-height: 2.5
vowels_nearey %>%
  group_by(name, ipa_vclass) %>%
...
In order to plot these points in an F1$\times$F2 space, we need to do a little `pivot_longer()` and `pivot_wider()` again.
